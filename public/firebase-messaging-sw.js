...
// ============================================
const CACHE_VERSION = 'v179'; // v179: pestana activa en la barra del widget + Depositar como pestana propia. v178: hub PREMIOS muestra reembolsos diario/semanal/mensual (con reclamo) cuando el cashback esta apagado. v177: reembolso DIARIO de vuelta + 'ya reembolsado' en semanal/mensual. v176: '¿Como funciona?' abre/cierra (toggle) + boton Cerrar. v175: dos formas de cargar (automatica / con un agente) con cambio facil. v174: etiquetas radiales centradas en la rueda + sin scroll horizontal. v173: escucha rewards_changed (reset de ruleta por usuario desde el panel). v172: cambiar contraseña — mínimo 6 caracteres (antes 8)
