...
// ============================================
const CACHE_VERSION = 'v182'; // v182: avisos 'app instalada + notificaciones activas' (2 cosas) en reembolsos y ruleta. v181: reembolsos exigen app instalada (needsApp) + boton Instalar App vuelve cada 24h. v180: widget redimensionable (agarre arriba) + Depositar de nuevo vuelve a elegir modo. v179: pestana activa en la barra del widget + Depositar como pestana propia. v178: hub PREMIOS muestra reembolsos diario/semanal/mensual (con reclamo) cuando el cashback esta apagado. v177: reembolso DIARIO de vuelta + 'ya reembolsado' en semanal/mensual. v176: '¿Como funciona?' abre/cierra (toggle) + boton Cerrar. v175: dos formas de cargar (automatica / con un agente) con cambio facil. v174: etiquetas radiales centradas en la rueda + sin scroll horizontal. v173: escucha rewards_changed (reset de ruleta por usuario desde el panel). v172: cambiar contraseña — mínimo 6 caracteres (antes 8)
...
// v138: // v138: ruleta de bienvenida en OVERLAY a pantalla completa (rueda ~340px, resultado y botones ahi mismo) + pantalla "Mi premio" reabrible
