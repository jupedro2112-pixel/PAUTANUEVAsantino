...
const CACHE_VERSION = 'v60'; // v60: ruleta diaria muestra % EXTRA aplicados (quien/cuando/cuanto) + bonos aplicados en carga como Bonificacion. v59: rangos de reembolso con DIARIO (escalera, minimo, interruptor). v58: etiqueta CARGA MANUAL / AUTO al lado del nombre en el chat. v57: reiniciar ruleta (bienvenida/diaria) para UN usuario (pruebas) en el chat y en la seccion Ruleta. v56: banner 'BIENVENIDA: cobró el 100% de 1ª carga — ruleta USADA'. v55: tope del bono 100% (hasta $ + % del resto) en la card de 1ª carga + aviso ruleta solo auto-registro. v54: iconos banco/titular en el banner de multicuenta. v53: card Rollover GLOBAL de bonos (x0/x2/x3/x5/x10). v52: sesion deslizante (token cada 30 min, re-auth del socket sin recargar). v51: transacciones con origen (ruleta diaria/bienvenida, cashback, lote...) + labels rakeback/VIP. v50: lote 'solo aviso' + compositor/difusion viejos ocultos. v49: rollover propio del % automatico del lote. v48: lote con regalo — % AUTOMATICO en la carga (primera/todas + franja horaria) + audiencia por segmento
